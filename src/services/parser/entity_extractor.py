...
class EntityExtractor:
    ...
    def log_dict_value_types(self, input_dict):
        logger.info("\nLogging dictionary value types")
    ...
    def extract_entities(self, resume_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        """
        try:
            # log the dictionary value types
            self.log_dict_value_types(resume_data)
            ...
            logger.info("ENTITIES DICT BEFORE CREATING SUMMARY HTML ", entities)
